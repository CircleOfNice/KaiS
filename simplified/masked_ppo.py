...
custom_env = CustomEnv(10, 0, result_list, True)   # Initialize env
...
model = MaskablePPO(MaskableActorCriticPolicy, customenv, verbose=1, tensorboard_log="tensorboard_logs")#, verbose=True)
